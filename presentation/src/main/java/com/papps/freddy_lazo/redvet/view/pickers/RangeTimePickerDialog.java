...
public class RangeTimePickerDialog extends TimePickerDialog {
    ...
    public RangeTimePickerDialog(Context context, int dialogTheme, OnTimeSetListener callBack, int hourOfDay, int minute, boolean is24HourView) {
        super(context, dialogTheme, callBack, hourOfDay, minute, is24HourView);
    ...
    public static RangeTimePickerDialog newInstance(BaseActivity activity) {
        Calendar rightNow = Calendar.getInstance();
        int hour = rightNow.get(Calendar.HOUR_OF_DAY);
        int minute = rightNow.get(Calendar.MINUTE);
       return new RangeTimePickerDialog(activity, AlertDialog.THEME_HOLO_LIGHT,(OnTimeSetListener) activity, 10,0,false);
    }
