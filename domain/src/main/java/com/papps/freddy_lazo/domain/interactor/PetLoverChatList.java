...
public class PetLoverChatList extends UseCase {
    ...
    @Inject
    PetLoverChatList(UtilsRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable buildUseCaseObservable() {
        return repository.petLoverChat(apiToken, appointmentId);
    }
}
