...
public class ForgotPassword extends UseCase {

    private final UtilsRepository repository;
    private String email;

    @Inject
    ForgotPassword(UtilsRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
        super(threadExecutor, postExecutionThread);
        this.repository = repository;
    }

    public void bindParams(String email){
        this.email = email;
    }
