...
public class MessagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        if (viewType == VIEW_TYPE_PET_LOVER) {
            return new PetLoverMessageViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_doctor_pet_lover_message, viewGroup, false));
        } else {
            return new DoctorMessageViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_doctor_doctor_message, viewGroup, false));
        }
    }
