...
public class PetLoverAppointmentUseCase extends UseCase {
    ...
    @Inject
    PetLoverAppointmentUseCase(UtilsRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable buildUseCaseObservable() {
        return repository.petLoverAppointments(apiToken);
    }
}
